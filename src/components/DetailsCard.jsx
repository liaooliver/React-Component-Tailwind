  ...
  return (
    <div style={{ width: '360px' }} className='py-2 px-3 bg-gray-200 rounded-md'>
      <div className='flex mb-4'>
        <button autoFocus type="button" onClick={() => { sliderContent(0) }} onKeyDown={sliderContent} className='w-1/3 focus:shadow-md focus:outline-none focus:bg-white text-black font-bold py-2 px-4 rounded-md'>Details</button>
